...
/** Handles io.papermc.paper.event.connection.PlayerConnectionValidateLoginEvent. */
export const OnPlayerConnectionValidateLoginEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionValidateLoginEvent', "io.papermc.paper.event.connection.PlayerConnectionValidateLoginEvent", priority, receiveCancelled);
