...
/** Handles com.destroystokyo.paper.event.brigadier.AsyncPlayerSendCommandsEvent. */
export const OnAsyncPlayerSendCommandsEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerSendCommandsEvent', "com.destroystokyo.paper.event.brigadier.AsyncPlayerSendCommandsEvent", priority, receiveCancelled);
/** Handles com.destroystokyo.paper.event.brigadier.AsyncPlayerSendSuggestionsEvent. */
export const OnAsyncPlayerSendSuggestionsEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerSendSuggestionsEvent', "com.destroystokyo.paper.event.brigadier.AsyncPlayerSendSuggestionsEvent", priority, receiveCancelled);
/** Handles com.destroystokyo.paper.event.brigadier.CommandRegisteredEvent. */
export const OnCommandRegisteredEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnCommandRegisteredEvent', "com.destroystokyo.paper.event.brigadier.CommandRegisteredEvent", priority, receiveCancelled);
