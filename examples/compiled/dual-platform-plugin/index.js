...
// src/plugin.ts
var _enabled, _statusChecks, DualPlatformPlugin;
var init_plugin = __esm({
  "src/plugin.ts"() {
    "use strict";
    init_src();
    DualPlatformPlugin = class {
      constructor() {
...
var init_paper2 = __esm({
  "shamoo-platform:paper"() {
    init_paper();
    init_plugin();
    components = Object.freeze({ "src/plugin.ts#DualPlatformPlugin": DualPlatformPlugin });
  }
});
...
var init_velocity2 = __esm({
  "shamoo-platform:velocity"() {
    init_velocity();
    init_plugin();
    components2 = Object.freeze({ "src/plugin.ts#DualPlatformPlugin": DualPlatformPlugin });
  }
});
...
var lifecycle = createRuntimeLifecycle({ paper: () => Promise.resolve().then(() => (init_paper2(), paper_exports)), velocity: () => Promise.resolve().then(() => (init_velocity2(), velocity_exports)) });
