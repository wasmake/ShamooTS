...
export const OnStructuresLocateEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnStructuresLocateEvent', "io.papermc.paper.event.world.StructuresLocateEvent");
/** Handles io.papermc.paper.event.world.WorldDifficultyChangeEvent. */
export const OnWorldDifficultyChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWorldDifficultyChangeEvent', "io.papermc.paper.event.world.WorldDifficultyChangeEvent");
/** Handles io.papermc.paper.event.world.WorldGameRuleChangeEvent. */
export const OnWorldGameRuleChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWorldGameRuleChangeEvent', "io.papermc.paper.event.world.WorldGameRuleChangeEvent");
