...
__export(velocity_exports, {
  DualPlatformPlugin: () => DualPlatformPlugin,
...
// src/plugin.ts
var _enabled, _statusChecks;
var DualPlatformPlugin = class {
  constructor() {
    __privateAdd(this, _enabled, false);
    __privateAdd(this, _statusChecks, 0);
  }
  get enabled() {
  ...
  status() {
    __privateSet(this, _statusChecks, __privateGet(this, _statusChecks) + 1);
    return __privateGet(this, _enabled) ? __privateGet(this, _statusChecks) : 0;
  }
};
_enabled = new WeakMap();
_statusChecks = new WeakMap();
__decorateClass([
  OnEnable()
], DualPlatformPlugin.prototype, "enable", 1);
__decorateClass([
  OnDisable()
], DualPlatformPlugin.prototype, "disable", 1);
__decorateClass([
  Command("shamoo-status")
], DualPlatformPlugin.prototype, "status", 1);
DualPlatformPlugin = __decorateClass([
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/dual-platform-plugin", "components": [{ "id": "src/plugin.ts#DualPlatformPlugin", "kind": "plugin", "name": "DualPlatformPlugin", "file": "src/plugin.ts", "platform": "common", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "dual-platform-plugin" }], "location": { "file": "src/plugin.ts", "line": 3, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "enable", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 12, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 12, "column": 3 } }, { "name": "disable", "lifecycle": "disable", "decorators": [{ "name": "OnDisable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 17, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 17, "column": 3 } }, { "name": "status", "invocation": "command", "decorators": [{ "name": "Command", "arguments": ["shamoo-status"], "location": { "file": "src/plugin.ts", "line": 22, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 22, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 3, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "paper": { "source": "src/paper.ts", "output": "paper/index.js" }, "velocity": { "source": "src/velocity.ts", "output": "velocity/index.js" } } }, "velocity", velocity_exports);
