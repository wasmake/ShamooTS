...
export const OnServerResourcesReloadedEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnServerResourcesReloadedEvent', "io.papermc.paper.event.server.ServerResourcesReloadedEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.server.WhitelistStateUpdateEvent. */
export const OnWhitelistStateUpdateEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWhitelistStateUpdateEvent', "io.papermc.paper.event.server.WhitelistStateUpdateEvent", priority, receiveCancelled);
