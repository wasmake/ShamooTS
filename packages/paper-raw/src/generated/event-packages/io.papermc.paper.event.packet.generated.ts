...
export const OnClientTickEndEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnClientTickEndEvent', "io.papermc.paper.event.packet.ClientTickEndEvent");
/** Handles io.papermc.paper.event.packet.PlayerChunkLoadEvent. */
export const OnPlayerChunkLoadEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPlayerChunkLoadEvent', "io.papermc.paper.event.packet.PlayerChunkLoadEvent");
/** Handles io.papermc.paper.event.packet.PlayerChunkUnloadEvent. */
export const OnPlayerChunkUnloadEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPlayerChunkUnloadEvent', "io.papermc.paper.event.packet.PlayerChunkUnloadEvent");
/** Handles io.papermc.paper.event.packet.UncheckedSignChangeEvent. */
export const OnUncheckedSignChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnUncheckedSignChangeEvent', "io.papermc.paper.event.packet.UncheckedSignChangeEvent");
