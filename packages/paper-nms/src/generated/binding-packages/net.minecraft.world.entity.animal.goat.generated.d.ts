...
export interface GoatMembers {
  ...
  aiStep(): void;
  brainProvider(): j_net_minecraft_world_entity_ai.Brain_Provider<Goat>;
  ...
  getMilkingSound(): j_net_minecraft_sounds.SoundEvent;
...
export interface GoatStatics {
  ...
  readonly SENSOR_TYPES: JavaOpaque<"com.google.common.collect.ImmutableList", [j_net_minecraft_world_entity_ai_sensing.SensorType<j_net_minecraft_world_entity_ai_sensing.Sensor<Goat>>]>;
...
export interface GoatAiStatics {
  ...
  initMemories(arg0: Goat, arg1: j_net_minecraft_util.RandomSource): void;
  makeBrain(arg0: j_net_minecraft_world_entity_ai.Brain<Goat>): j_net_minecraft_world_entity_ai.Brain<object>;
