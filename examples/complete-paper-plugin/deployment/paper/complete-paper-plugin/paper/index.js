...
__export(paper_exports, {
  CompletePaperPlugin: () => CompletePaperPlugin,
...
var OnPlayerJoinEvent = () => generatedEventDecorator("OnPlayerJoinEvent", "org.bukkit.event.player.PlayerJoinEvent");

// src/plugin.ts
var CompletePaperPlugin = class {
  joins = 0;
  heartbeats = 0;
  ready = false;
  loaded() {
...
], CompletePaperPlugin.prototype, "heartbeat", 1);
__decorateClass([
  OnDrain()
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/complete-paper-plugin", "components": [{ "id": "src/plugin.ts#CompletePaperPlugin", "kind": "plugin", "name": "CompletePaperPlugin", "file": "src/plugin.ts", "platform": "paper", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "complete-paper-plugin" }], "location": { "file": "src/plugin.ts", "line": 7, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "loaded", "lifecycle": "load", "decorators": [{ "name": "OnLoad", "arguments": [], "location": { "file": "src/plugin.ts", "line": 13, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 13, "column": 3 } }, { "name": "enabled", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 18, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 18, "column": 3 } }, { "name": "becameReady", "lifecycle": "ready", "decorators": [{ "name": "OnReady", "arguments": [], "location": { "file": "src/plugin.ts", "line": 23, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 23, "column": 3 } }, { "name": "playerJoined", "invocation": "event", "decorators": [{ "name": "OnPlayerJoinEvent", "arguments": [], "location": { "file": "src/plugin.ts", "line": 29, "column": 3 } }], "parameters": [{ "index": 0, "token": { "kind": "token", "value": { "binding": "Context", "value": "value" } }, "location": { "file": "src/plugin.ts", "line": 30, "column": 23 } }], "location": { "file": "src/plugin.ts", "line": 29, "column": 3 } }, { "name": "status", "invocation": "command", "decorators": [{ "name": "Command", "arguments": ["shamoo-status"], "location": { "file": "src/plugin.ts", "line": 36, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 36, "column": 3 } }, { "name": "heartbeat", "invocation": "task", "decorators": [{ "name": "Scheduled", "arguments": [{ "delay": 20, "unit": "ticks" }], "location": { "file": "src/plugin.ts", "line": 44, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 44, "column": 3 } }, { "name": "draining", "lifecycle": "drain", "decorators": [{ "name": "OnDrain", "arguments": [], "location": { "file": "src/plugin.ts", "line": 50, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 50, "column": 3 } }, { "name": "disabled", "lifecycle": "disable", "decorators": [{ "name": "OnDisable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 56, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 56, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 7, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "paper": { "source": "src/paper.ts", "output": "paper/index.js" } } }, "paper", paper_exports);
