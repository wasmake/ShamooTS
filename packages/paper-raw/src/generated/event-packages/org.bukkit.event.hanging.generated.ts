...
export const OnHangingBreakByEntityEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnHangingBreakByEntityEvent', "org.bukkit.event.hanging.HangingBreakByEntityEvent");
/** Handles org.bukkit.event.hanging.HangingBreakEvent. */
export const OnHangingBreakEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnHangingBreakEvent', "org.bukkit.event.hanging.HangingBreakEvent");
/** Handles org.bukkit.event.hanging.HangingPlaceEvent. */
export const OnHangingPlaceEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnHangingPlaceEvent', "org.bukkit.event.hanging.HangingPlaceEvent");
