...
__export(paper_exports, {
  FoliaPlugin: () => FoliaPlugin,
  default: () => paper_default,
  scheduleOwnedWork: () => scheduleOwnedWork
});
...
// src/folia.ts
function scheduleOwnedWork(scheduler, request) {
...
__decorateClass([
  OnEnable()
], FoliaPlugin.prototype, "enabled", 1);
__decorateClass([
  OnDisable()
], FoliaPlugin.prototype, "disabled", 1);
FoliaPlugin = __decorateClass([
  Plugin({ name: "folia" })
], FoliaPlugin);
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/folia", "components": [{ "id": "src/plugin.ts#FoliaPlugin", "kind": "plugin", "name": "FoliaPlugin", "file": "src/plugin.ts", "platform": "common", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "folia" }], "location": { "file": "src/plugin.ts", "line": 3, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "enabled", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 5, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 5, "column": 3 } }, { "name": "disabled", "lifecycle": "disable", "decorators": [{ "name": "OnDisable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 10, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 10, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 3, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "paper": { "source": "src/paper.ts", "output": "paper/index.js" } } }, "paper", paper_exports);
