...
/** Handles org.bukkit.event.command.UnknownCommandEvent. */
export const OnUnknownCommandEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnUnknownCommandEvent', "org.bukkit.event.command.UnknownCommandEvent", priority, receiveCancelled);
