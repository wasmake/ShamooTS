...
/** Handles io.papermc.paper.event.world.border.WorldBorderBoundsChangeEvent. */
export const OnWorldBorderBoundsChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderBoundsChangeEvent', "io.papermc.paper.event.world.border.WorldBorderBoundsChangeEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.world.border.WorldBorderBoundsChangeFinishEvent. */
export const OnWorldBorderBoundsChangeFinishEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderBoundsChangeFinishEvent', "io.papermc.paper.event.world.border.WorldBorderBoundsChangeFinishEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.world.border.WorldBorderCenterChangeEvent. */
export const OnWorldBorderCenterChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderCenterChangeEvent', "io.papermc.paper.event.world.border.WorldBorderCenterChangeEvent", priority, receiveCancelled);
