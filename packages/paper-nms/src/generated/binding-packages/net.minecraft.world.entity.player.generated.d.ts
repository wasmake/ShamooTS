...
export interface StackedContentsMembers<T = unknown> {
  ...
  tryPick(arg0: JavaList<StackedContents_IngredientInfo<T>>, arg1: number, arg2: StackedContents_Output<T> | null): boolean;
  tryPickAll(arg0: JavaList<StackedContents_IngredientInfo<T>>, arg1: number, arg2: StackedContents_Output<T> | null): number;
}
...
export interface StackedItemContentsMembers {
  ...
  canCraft(arg0: JavaList<StackedContents_IngredientInfo<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">>>, arg1: StackedContents_Output<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">> | null): boolean;
  canCraft(arg0: j_net_minecraft_world_item_crafting.Recipe<object>, arg1: number, arg2: StackedContents_Output<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">> | null): boolean;
  canCraft(arg0: j_net_minecraft_world_item_crafting.Recipe<object>, arg1: StackedContents_Output<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">> | null): boolean;
  clear(): void;
  getBiggestCraftableStack(arg0: j_net_minecraft_world_item_crafting.Recipe<object>, arg1: number, arg2: StackedContents_Output<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">> | null): number;
  getBiggestCraftableStack(arg0: j_net_minecraft_world_item_crafting.Recipe<object>, arg1: StackedContents_Output<JavaOpaque<"io.papermc.paper.inventory.recipe.ItemOrExact">> | null): number;
  initializeExtras(arg0: j_net_minecraft_world_item_crafting.Recipe<object>, arg1: j_net_minecraft_world_item_crafting.CraftingInput | null): void;
  resetExtras(): void;
}
