...
export const OnAsyncPlayerSendCommandsEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerSendCommandsEvent', "com.destroystokyo.paper.event.brigadier.AsyncPlayerSendCommandsEvent");
/** Handles com.destroystokyo.paper.event.brigadier.AsyncPlayerSendSuggestionsEvent. */
export const OnAsyncPlayerSendSuggestionsEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerSendSuggestionsEvent', "com.destroystokyo.paper.event.brigadier.AsyncPlayerSendSuggestionsEvent");
/** Handles com.destroystokyo.paper.event.brigadier.CommandRegisteredEvent. */
export const OnCommandRegisteredEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnCommandRegisteredEvent', "com.destroystokyo.paper.event.brigadier.CommandRegisteredEvent");
