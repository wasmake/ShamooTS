...
export const OnPrepareGrindstoneEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPrepareGrindstoneEvent', "com.destroystokyo.paper.event.inventory.PrepareGrindstoneEvent");
/** Handles com.destroystokyo.paper.event.inventory.PrepareResultEvent. */
export const OnPrepareResultEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPrepareResultEvent', "com.destroystokyo.paper.event.inventory.PrepareResultEvent");
