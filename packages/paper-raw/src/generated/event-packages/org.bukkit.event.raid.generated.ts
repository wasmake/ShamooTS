...
export const OnRaidFinishEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnRaidFinishEvent', "org.bukkit.event.raid.RaidFinishEvent");
/** Handles org.bukkit.event.raid.RaidSpawnWaveEvent. */
export const OnRaidSpawnWaveEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnRaidSpawnWaveEvent', "org.bukkit.event.raid.RaidSpawnWaveEvent");
/** Handles org.bukkit.event.raid.RaidStopEvent. */
export const OnRaidStopEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnRaidStopEvent', "org.bukkit.event.raid.RaidStopEvent");
/** Handles org.bukkit.event.raid.RaidTriggerEvent. */
export const OnRaidTriggerEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnRaidTriggerEvent', "org.bukkit.event.raid.RaidTriggerEvent");
