...
/** Handles com.destroystokyo.paper.loottable.LootableInventoryReplenishEvent. */
export const OnLootableInventoryReplenishEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnLootableInventoryReplenishEvent', "com.destroystokyo.paper.loottable.LootableInventoryReplenishEvent", priority, receiveCancelled);
