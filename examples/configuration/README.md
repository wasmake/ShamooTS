...
Use the checked-in [`examples/compiled/configuration`](../compiled/configuration) installation, or
download `shamoo-example-configuration-<version>.tgz` from the GitHub release. Copy or extract it
