...
__export(velocity_exports, {
  CompleteVelocityPlugin: () => CompleteVelocityPlugin,
  default: () => velocity_default,
  velocityEntrypoint: () => velocityEntrypoint
});
...
var OnDisconnectEvent = () => generatedEventDecorator("OnDisconnectEvent", "com.velocitypowered.api.event.connection.DisconnectEvent");
var OnPostLoginEvent = () => generatedEventDecorator("OnPostLoginEvent", "com.velocitypowered.api.event.connection.PostLoginEvent");

// src/plugin.ts
var _onlinePlayers, _phase;
var CompleteVelocityPlugin = class {
  constructor() {
    __privateAdd(this, _onlinePlayers, /* @__PURE__ */ new Set());
  ...
  get onlinePlayers() {
    return Object.freeze([...__privateGet(this, _onlinePlayers)].sort());
  }
  load() {
  ...
  disable() {
    ...
    __privateGet(this, _onlinePlayers).clear();
  }
  unload() {
    __privateSet(this, _phase, "unloaded");
  }
  playerJoined(event) {
    __privateGet(this, _onlinePlayers).add(event.getPlayer().getUsername());
  }
  playerDisconnected(event) {
    __privateGet(this, _onlinePlayers).delete(event.getPlayer().getUsername());
  }
  status() {
    return __privateGet(this, _onlinePlayers).size;
  }
};
_onlinePlayers = new WeakMap();
_phase = new WeakMap();
__decorateClass([
  OnLoad()
...
function defineVelocityEntrypoint(entrypoint) {
  return Object.freeze(entrypoint);
}

// src/velocity.ts
var velocityEntrypoint = defineVelocityEntrypoint({
  start() {
...
var velocity_default = velocityEntrypoint;
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/complete-velocity-plugin", "components": [{ "id": "src/plugin.ts#CompleteVelocityPlugin", "kind": "plugin", "name": "CompleteVelocityPlugin", "file": "src/plugin.ts", "platform": "velocity", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "complete-velocity-plugin" }], "location": { "file": "src/plugin.ts", "line": 22, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "load", "lifecycle": "load", "decorators": [{ "name": "OnLoad", "arguments": [], "location": { "file": "src/plugin.ts", "line": 35, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 35, "column": 3 } }, { "name": "enable", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 40, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 40, "column": 3 } }, { "name": "ready", "lifecycle": "ready", "decorators": [{ "name": "OnReady", "arguments": [], "location": { "file": "src/plugin.ts", "line": 45, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 45, "column": 3 } }, { "name": "drain", "lifecycle": "drain", "decorators": [{ "name": "OnDrain", "arguments": [], "location": { "file": "src/plugin.ts", "line": 50, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 50, "column": 3 } }, { "name": "disable", "lifecycle": "disable", "decorators": [{ "name": "OnDisable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 55, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 55, "column": 3 } }, { "name": "unload", "lifecycle": "unload", "decorators": [{ "name": "OnUnload", "arguments": [], "location": { "file": "src/plugin.ts", "line": 61, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 61, "column": 3 } }, { "name": "playerJoined", "invocation": "event", "decorators": [{ "name": "OnPostLoginEvent", "arguments": [], "location": { "file": "src/plugin.ts", "line": 66, "column": 3 } }], "parameters": [{ "index": 0, "token": { "kind": "token", "value": { "binding": "Context", "value": "value" } }, "location": { "file": "src/plugin.ts", "line": 67, "column": 23 } }], "location": { "file": "src/plugin.ts", "line": 66, "column": 3 } }, { "name": "playerDisconnected", "invocation": "event", "decorators": [{ "name": "OnDisconnectEvent", "arguments": [], "location": { "file": "src/plugin.ts", "line": 71, "column": 3 } }], "parameters": [{ "index": 0, "token": { "kind": "token", "value": { "binding": "Context", "value": "value" } }, "location": { "file": "src/plugin.ts", "line": 72, "column": 29 } }], "location": { "file": "src/plugin.ts", "line": 71, "column": 3 } }, { "name": "status", "invocation": "command", "decorators": [{ "name": "Command", "arguments": ["velocity-status"], "location": { "file": "src/plugin.ts", "line": 76, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 76, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 22, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "velocity": { "source": "src/velocity.ts", "output": "velocity/index.js" } } }, "velocity", velocity_exports);
