...
export const OnLightningStrikeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnLightningStrikeEvent', "org.bukkit.event.weather.LightningStrikeEvent");
/** Handles org.bukkit.event.weather.ThunderChangeEvent. */
export const OnThunderChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnThunderChangeEvent', "org.bukkit.event.weather.ThunderChangeEvent");
/** Handles org.bukkit.event.weather.WeatherChangeEvent. */
export const OnWeatherChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWeatherChangeEvent', "org.bukkit.event.weather.WeatherChangeEvent");
