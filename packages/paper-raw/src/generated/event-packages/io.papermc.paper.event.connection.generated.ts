...
export const OnPlayerConnectionValidateLoginEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionValidateLoginEvent', "io.papermc.paper.event.connection.PlayerConnectionValidateLoginEvent");
