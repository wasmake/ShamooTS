...
/** Handles io.papermc.paper.event.world.StructuresLocateEvent. */
export const OnStructuresLocateEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnStructuresLocateEvent', "io.papermc.paper.event.world.StructuresLocateEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.world.WorldDifficultyChangeEvent. */
export const OnWorldDifficultyChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWorldDifficultyChangeEvent', "io.papermc.paper.event.world.WorldDifficultyChangeEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.world.WorldGameRuleChangeEvent. */
export const OnWorldGameRuleChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWorldGameRuleChangeEvent', "io.papermc.paper.event.world.WorldGameRuleChangeEvent", priority, receiveCancelled);
