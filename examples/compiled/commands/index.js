...
function Subcommand2(rootOrSyntax, syntaxOrOptions, options) {
  if (typeof syntaxOrOptions === "string") {
    return options === void 0 ? Subcommand(rootOrSyntax, syntaxOrOptions) : Subcommand(rootOrSyntax, syntaxOrOptions, options);
  }
  return syntaxOrOptions === void 0 ? Subcommand(rootOrSyntax) : Subcommand(rootOrSyntax, syntaxOrOptions);
}
...
function legacyText(content, character = "&") {
...
var init_plugin = __esm({
  "src/plugin.ts"() {
    ...
    CommandsPlugin = class {
      ...
      async greet(player, message, uppercase, sender, context) {
      ...
      async grant(material, amount, announce, sender, context) {
    ...
    __decorateClass([
      Command2("shamoo-greet [player] [message...]", {
        aliases: ["sgreet"],
        description: "Greet an online player with an optional custom message."
      }),
      __decorateParam(0, Argument2("player", { parser: "player", suggestions: ["players"] })),
      __decorateParam(1, Argument2("message")),
      __decorateParam(2, Option2("uppercase", { aliases: ["u"], parser: "boolean" })),
      __decorateParam(3, Sender2()),
      __decorateParam(4, Context2())
    ], CommandsPlugin.prototype, "greet", 1);
    __decorateClass([
      Subcommand2("shamoo-showcase", "menu", {
        aliases: ["shamoo-demo"],
    ...
    ], CommandsPlugin.prototype, "menu", 1);
    __decorateClass([
      Subcommand2("shamoo-showcase", "grant <material> [amount]", {
        aliases: ["shamoo-demo"],
        description: "Grant an item whose left and right clicks run TypeScript callbacks.",
        permission: "shamoo.showcase",
        sender: "player"
      }),
      __decorateParam(0, Argument2("material", { parser: "material", suggestions: ["materials"] })),
      __decorateParam(1, Argument2("amount", { parser: "integer", suggestions: ["1", "16", "64"] })),
      __decorateParam(2, Option2("announce", { aliases: ["a"], parser: "boolean" })),
      __decorateParam(3, Sender2()),
      __decorateParam(4, Context2())
    ], CommandsPlugin.prototype, "grant", 1);
...
var init_paper2 = __esm({
  "shamoo-platform:paper"() {
    init_paper();
    init_plugin();
    components = Object.freeze({ "src/plugin.ts#CommandsPlugin": CommandsPlugin });
  }
});
