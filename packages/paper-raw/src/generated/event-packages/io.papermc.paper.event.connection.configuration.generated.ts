...
/** Handles io.papermc.paper.event.connection.configuration.AsyncPlayerConnectionConfigureEvent. */
export const OnAsyncPlayerConnectionConfigureEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerConnectionConfigureEvent', "io.papermc.paper.event.connection.configuration.AsyncPlayerConnectionConfigureEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.connection.configuration.PlayerConnectionInitialConfigureEvent. */
export const OnPlayerConnectionInitialConfigureEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionInitialConfigureEvent', "io.papermc.paper.event.connection.configuration.PlayerConnectionInitialConfigureEvent", priority, receiveCancelled);
/** Handles io.papermc.paper.event.connection.configuration.PlayerConnectionReconfigureEvent. */
export const OnPlayerConnectionReconfigureEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionReconfigureEvent', "io.papermc.paper.event.connection.configuration.PlayerConnectionReconfigureEvent", priority, receiveCancelled);
