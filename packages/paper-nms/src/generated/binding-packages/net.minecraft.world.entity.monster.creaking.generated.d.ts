...
export interface CreakingMembers {
  ...
  knockback(arg0: number, arg1: number, arg2: number, arg3: j_net_minecraft_world_entity.Entity | null, arg4: JavaOpaque<"io.papermc.paper.event.entity.EntityKnockbackEvent$Cause">): void | null;
...
export interface CreakingAiStatics {
  ...
  readonly SENSOR_TYPES: JavaOpaque<"com.google.common.collect.ImmutableList", [j_net_minecraft_world_entity_ai_sensing.SensorType<j_net_minecraft_world_entity_ai_sensing.Sensor<Creaking>>]>;
  brainProvider(): j_net_minecraft_world_entity_ai.Brain_Provider<Creaking>;
