...
export const OnServerRegisteredEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnServerRegisteredEvent', "com.velocitypowered.api.event.proxy.server.ServerRegisteredEvent");
/** Handles com.velocitypowered.api.event.proxy.server.ServerUnregisteredEvent. */
export const OnServerUnregisteredEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnServerUnregisteredEvent', "com.velocitypowered.api.event.proxy.server.ServerUnregisteredEvent");
