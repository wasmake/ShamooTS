...
/** Handles org.bukkit.event.raid.RaidFinishEvent. */
export const OnRaidFinishEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnRaidFinishEvent', "org.bukkit.event.raid.RaidFinishEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.raid.RaidSpawnWaveEvent. */
export const OnRaidSpawnWaveEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnRaidSpawnWaveEvent', "org.bukkit.event.raid.RaidSpawnWaveEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.raid.RaidStopEvent. */
export const OnRaidStopEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnRaidStopEvent', "org.bukkit.event.raid.RaidStopEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.raid.RaidTriggerEvent. */
export const OnRaidTriggerEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnRaidTriggerEvent', "org.bukkit.event.raid.RaidTriggerEvent", priority, receiveCancelled);
