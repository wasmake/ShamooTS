...
/** Handles org.spigotmc.event.player.PlayerSpawnLocationEvent. */
export const OnPlayerSpawnLocationEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPlayerSpawnLocationEvent', "org.spigotmc.event.player.PlayerSpawnLocationEvent", priority, receiveCancelled);
