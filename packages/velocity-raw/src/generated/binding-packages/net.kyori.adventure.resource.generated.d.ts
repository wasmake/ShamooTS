...
export interface ResourcePackInfo_2Members {
...
export type ResourcePackInfo_2 = ResourcePackInfo_2Members & ResourcePackInfoLike & JavaOpaque<"net.kyori.examination.Examinable">;
export interface ResourcePackInfo_2Statics {
  resourcePackInfo(): ResourcePackInfo_Builder_2;
  resourcePackInfo(arg0: JavaOpaque<"java.util.UUID">, arg1: JavaOpaque<"java.net.URI">, arg2: string): ResourcePackInfo_2;
}
...
export interface ResourcePackInfo_Builder_2Members {
  ...
  hash(arg0: string): ResourcePackInfo_Builder_2;
  id(arg0: JavaOpaque<"java.util.UUID">): ResourcePackInfo_Builder_2;
  uri(arg0: JavaOpaque<"java.net.URI">): ResourcePackInfo_Builder_2;
}
export type ResourcePackInfo_Builder_2 = ResourcePackInfo_Builder_2Members & j_net_kyori_adventure_builder.AbstractBuilder<ResourcePackInfo_2> & ResourcePackInfoLike;
export interface ResourcePackInfo_Builder_2Statics {
}
...
export interface ResourcePackRequestMembers {
  ...
  packs(): JavaList<ResourcePackInfo_2>;
