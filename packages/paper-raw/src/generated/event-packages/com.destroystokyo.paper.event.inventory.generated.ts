...
/** Handles com.destroystokyo.paper.event.inventory.PrepareGrindstoneEvent. */
export const OnPrepareGrindstoneEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPrepareGrindstoneEvent', "com.destroystokyo.paper.event.inventory.PrepareGrindstoneEvent", priority, receiveCancelled);
/** Handles com.destroystokyo.paper.event.inventory.PrepareResultEvent. */
export const OnPrepareResultEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPrepareResultEvent', "com.destroystokyo.paper.event.inventory.PrepareResultEvent", priority, receiveCancelled);
