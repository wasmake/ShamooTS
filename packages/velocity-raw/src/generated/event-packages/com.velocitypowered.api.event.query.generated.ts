...
/** Handles com.velocitypowered.api.event.query.ProxyQueryEvent. */
export const OnProxyQueryEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnProxyQueryEvent', "com.velocitypowered.api.event.query.ProxyQueryEvent", priority, receiveCancelled);
