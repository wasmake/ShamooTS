...
__export(paper_exports, {
  ...
  exampleConfigDecoder: () => exampleConfigDecoder
});

// ../../packages/config/src/index.ts
async function readConfig(source2, decoder) {
  return decoder.decode(await source2.load());
}
...
var exampleConfigDecoder = {
  decode(input) {
    ...
    if (typeof value.maximumGreetingLength !== "number" || !Number.isSafeInteger(value.maximumGreetingLength) || value.maximumGreetingLength <= 0) {
...
var ConfigurationPlugin = class {
  ...
  enabled() {
    if (this.config === void 0) throw new Error("Configuration was not loaded before enable.");
...
__decorateClass([
  OnLoad()
], ConfigurationPlugin.prototype, "loadConfiguration", 1);
__decorateClass([
  OnEnable()
], ConfigurationPlugin.prototype, "enabled", 1);
__decorateClass([
  OnDisable()
], ConfigurationPlugin.prototype, "disabled", 1);
ConfigurationPlugin = __decorateClass([
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/configuration", "components": [{ "id": "src/plugin.ts#ConfigurationPlugin", "kind": "plugin", "name": "ConfigurationPlugin", "file": "src/plugin.ts", "platform": "common", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "configuration" }], "location": { "file": "src/plugin.ts", "line": 12, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "loadConfiguration", "lifecycle": "load", "decorators": [{ "name": "OnLoad", "arguments": [], "location": { "file": "src/plugin.ts", "line": 16, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 16, "column": 3 } }, { "name": "enabled", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 25, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 25, "column": 3 } }, { "name": "disabled", "lifecycle": "disable", "decorators": [{ "name": "OnDisable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 31, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 31, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 12, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "paper": { "source": "src/paper.ts", "output": "paper/index.js" } } }, "paper", paper_exports);
