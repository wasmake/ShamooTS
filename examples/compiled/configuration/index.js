...
function fileHost() {
  ...
  if (value === null || typeof value !== "object" || typeof Reflect.get(value, "shamooReadTextFile") !== "function" || typeof Reflect.get(value, "shamooWriteTextFile") !== "function")
...
var MemoryConfigSource, exampleConfigDecoder;
var init_config = __esm({
  "src/config.ts"() {
    "use strict";
    MemoryConfigSource = class {
      constructor(value) {
        this.value = value;
      }
      value;
...
// src/plugin.ts
var source, ConfigurationPlugin;
...
var init_paper2 = __esm({
  "shamoo-platform:paper"() {
    init_paper();
    init_plugin();
    components = Object.freeze({ "src/plugin.ts#ConfigurationPlugin": ConfigurationPlugin });
  }
});
...
function commandData(value, label, depth = 0) {
  ...
  return Object.freeze(
    Object.fromEntries(
      Object.keys(source2).map((key) => [key, commandData(source2[key], label, depth + 1)])
    )
  );
}
