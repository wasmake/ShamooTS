...
/** Handles org.bukkit.event.weather.LightningStrikeEvent. */
export const OnLightningStrikeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnLightningStrikeEvent', "org.bukkit.event.weather.LightningStrikeEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.weather.ThunderChangeEvent. */
export const OnThunderChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnThunderChangeEvent', "org.bukkit.event.weather.ThunderChangeEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.weather.WeatherChangeEvent. */
export const OnWeatherChangeEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnWeatherChangeEvent', "org.bukkit.event.weather.WeatherChangeEvent", priority, receiveCancelled);
