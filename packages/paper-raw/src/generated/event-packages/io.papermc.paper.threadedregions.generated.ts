...
/** Handles io.papermc.paper.threadedregions.RegionizedServerInitEvent. */
export const OnRegionizedServerInitEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnRegionizedServerInitEvent', "io.papermc.paper.threadedregions.RegionizedServerInitEvent", priority, receiveCancelled);
