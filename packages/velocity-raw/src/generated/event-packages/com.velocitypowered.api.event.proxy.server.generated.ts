...
/** Handles com.velocitypowered.api.event.proxy.server.ServerRegisteredEvent. */
export const OnServerRegisteredEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnServerRegisteredEvent', "com.velocitypowered.api.event.proxy.server.ServerRegisteredEvent", priority, receiveCancelled);
/** Handles com.velocitypowered.api.event.proxy.server.ServerUnregisteredEvent. */
export const OnServerUnregisteredEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnServerUnregisteredEvent', "com.velocitypowered.api.event.proxy.server.ServerUnregisteredEvent", priority, receiveCancelled);
