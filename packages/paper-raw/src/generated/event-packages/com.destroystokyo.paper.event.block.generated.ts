...
export const OnAnvilDamagedEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnAnvilDamagedEvent', "com.destroystokyo.paper.event.block.AnvilDamagedEvent");
/** Handles com.destroystokyo.paper.event.block.BeaconEffectEvent. */
export const OnBeaconEffectEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnBeaconEffectEvent', "com.destroystokyo.paper.event.block.BeaconEffectEvent");
/** Handles com.destroystokyo.paper.event.block.BlockDestroyEvent. */
export const OnBlockDestroyEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnBlockDestroyEvent', "com.destroystokyo.paper.event.block.BlockDestroyEvent");
/** Handles com.destroystokyo.paper.event.block.TNTPrimeEvent. */
export const OnTNTPrimeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnTNTPrimeEvent', "com.destroystokyo.paper.event.block.TNTPrimeEvent");
