...
var CommandsPlugin = class {
  ...
  greet(context) {
    ...
    const recipient = context.arguments.find((value) => value !== "--uppercase") ?? context.sender.name;
...
__decorateClass([
  OnEnable()
], CommandsPlugin.prototype, "enabled", 1);
__decorateClass([
  Command("shamoo-ping"),
  __decorateParam(0, Context())
], CommandsPlugin.prototype, "ping", 1);
__decorateClass([
  Command("shamoo-greet"),
  __decorateParam(0, Context())
], CommandsPlugin.prototype, "greet", 1);
CommandsPlugin = __decorateClass([
...
var lifecycle = installRuntimeAdapter({ "formatVersion": 2, "compilerVersion": "0.1.0-rc.1", "packageName": "@shamoo-examples/commands", "components": [{ "id": "src/plugin.ts#CommandsPlugin", "kind": "plugin", "name": "CommandsPlugin", "file": "src/plugin.ts", "platform": "paper", "decorators": [{ "name": "Plugin", "arguments": [{ "name": "commands" }], "location": { "file": "src/plugin.ts", "line": 5, "column": 1 } }], "constructor": [], "properties": [], "methods": [{ "name": "enabled", "lifecycle": "enable", "decorators": [{ "name": "OnEnable", "arguments": [], "location": { "file": "src/plugin.ts", "line": 7, "column": 3 } }], "parameters": [], "location": { "file": "src/plugin.ts", "line": 7, "column": 3 } }, { "name": "ping", "invocation": "command", "decorators": [{ "name": "Command", "arguments": ["shamoo-ping"], "location": { "file": "src/plugin.ts", "line": 12, "column": 3 } }], "parameters": [{ "index": 0, "token": { "kind": "token", "value": { "binding": "Context", "value": "value" } }, "location": { "file": "src/plugin.ts", "line": 13, "column": 15 } }], "location": { "file": "src/plugin.ts", "line": 12, "column": 3 } }, { "name": "greet", "invocation": "command", "decorators": [{ "name": "Command", "arguments": ["shamoo-greet"], "location": { "file": "src/plugin.ts", "line": 18, "column": 3 } }], "parameters": [{ "index": 0, "token": { "kind": "token", "value": { "binding": "Context", "value": "value" } }, "location": { "file": "src/plugin.ts", "line": 19, "column": 16 } }], "location": { "file": "src/plugin.ts", "line": 18, "column": 3 } }], "location": { "file": "src/plugin.ts", "line": 5, "column": 1 } }], "modules": [], "communication": { "services": [], "events": [], "consumers": [] }, "permissions": { "builtins": [], "filesystem": { "read": [], "write": [] } }, "entrypoints": { "paper": { "source": "src/paper.ts", "output": "paper/index.js" } } }, "paper", paper_exports);
