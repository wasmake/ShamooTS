...
export const OnCommandExecuteEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnCommandExecuteEvent', "com.velocitypowered.api.event.command.CommandExecuteEvent", priority, receiveCancelled);
/** Handles com.velocitypowered.api.event.command.PlayerAvailableCommandsEvent. */
export const OnPlayerAvailableCommandsEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPlayerAvailableCommandsEvent', "com.velocitypowered.api.event.command.PlayerAvailableCommandsEvent", priority, receiveCancelled);
/** Handles com.velocitypowered.api.event.command.PostCommandInvocationEvent. */
export const OnPostCommandInvocationEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPostCommandInvocationEvent', "com.velocitypowered.api.event.command.PostCommandInvocationEvent", priority, receiveCancelled);
