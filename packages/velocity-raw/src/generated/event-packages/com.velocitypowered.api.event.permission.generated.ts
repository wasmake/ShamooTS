...
/** Handles com.velocitypowered.api.event.permission.PermissionsSetupEvent. */
export const OnPermissionsSetupEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPermissionsSetupEvent', "com.velocitypowered.api.event.permission.PermissionsSetupEvent", priority, receiveCancelled);
