...
/** Handles org.bukkit.event.hanging.HangingBreakByEntityEvent. */
export const OnHangingBreakByEntityEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnHangingBreakByEntityEvent', "org.bukkit.event.hanging.HangingBreakByEntityEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.hanging.HangingBreakEvent. */
export const OnHangingBreakEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnHangingBreakEvent', "org.bukkit.event.hanging.HangingBreakEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.hanging.HangingPlaceEvent. */
export const OnHangingPlaceEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnHangingPlaceEvent', "org.bukkit.event.hanging.HangingPlaceEvent", priority, receiveCancelled);
