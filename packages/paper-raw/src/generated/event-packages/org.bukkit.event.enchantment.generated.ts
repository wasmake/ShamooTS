...
export const OnEnchantItemEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnEnchantItemEvent', "org.bukkit.event.enchantment.EnchantItemEvent", priority, receiveCancelled);
/** Handles org.bukkit.event.enchantment.PrepareItemEnchantEvent. */
export const OnPrepareItemEnchantEvent = (priority: GeneratedEventPriority = 'NORMAL', receiveCancelled = false): GeneratedEventDecorator => generatedEventDecorator('OnPrepareItemEnchantEvent', "org.bukkit.event.enchantment.PrepareItemEnchantEvent", priority, receiveCancelled);
