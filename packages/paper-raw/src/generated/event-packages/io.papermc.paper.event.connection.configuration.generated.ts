...
export const OnAsyncPlayerConnectionConfigureEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnAsyncPlayerConnectionConfigureEvent', "io.papermc.paper.event.connection.configuration.AsyncPlayerConnectionConfigureEvent");
/** Handles io.papermc.paper.event.connection.configuration.PlayerConnectionInitialConfigureEvent. */
export const OnPlayerConnectionInitialConfigureEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionInitialConfigureEvent', "io.papermc.paper.event.connection.configuration.PlayerConnectionInitialConfigureEvent");
/** Handles io.papermc.paper.event.connection.configuration.PlayerConnectionReconfigureEvent. */
export const OnPlayerConnectionReconfigureEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnPlayerConnectionReconfigureEvent', "io.papermc.paper.event.connection.configuration.PlayerConnectionReconfigureEvent");
