...
export const OnWorldBorderBoundsChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderBoundsChangeEvent', "io.papermc.paper.event.world.border.WorldBorderBoundsChangeEvent");
/** Handles io.papermc.paper.event.world.border.WorldBorderBoundsChangeFinishEvent. */
export const OnWorldBorderBoundsChangeFinishEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderBoundsChangeFinishEvent', "io.papermc.paper.event.world.border.WorldBorderBoundsChangeFinishEvent");
/** Handles io.papermc.paper.event.world.border.WorldBorderCenterChangeEvent. */
export const OnWorldBorderCenterChangeEvent = (): GeneratedEventDecorator => generatedEventDecorator('OnWorldBorderCenterChangeEvent', "io.papermc.paper.event.world.border.WorldBorderCenterChangeEvent");
